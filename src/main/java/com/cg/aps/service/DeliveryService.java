...
public interface DeliveryService {
	...
	public Delivery findByName(String name) throws RecordNotFoundException;
	public Delivery findByPk(Integer id) throws RecordNotFoundException;
	public List<Delivery> search(Long pageNo, Integer pageSize) throws DatabaseException;
